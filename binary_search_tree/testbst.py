...
def main():
    ...
    print('Succ 70: ', tree.successor(70))
    print('Succ 74: ', tree.successor(74))
    print('Succ 90: ', tree.successor(90))
    print('Pred 70: ', tree.predecessor(70))
    print('Pred 74: ', tree.predecessor(74))
    print('Pred 90: ', tree.predecessor(90))

    print(tree.rangeFind(45, 113))
